 ...
 */
public abstract class AbstractNotification implements Initializable {
    ...
    public AbstractNotification setTimer(final int timer) {
    ...
    public AbstractNotification setTitle(final String title) {
